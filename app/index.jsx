...
const Welcome = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-primary">
            ...
            {/* patterns */}
            <Image source={images.pattern1} resizeMode='contain' className='absolute -top-16 left-0 w-full h-full' />
            {/* content */}
            <ScrollView contentContainerStyle={{ width: '100%', height: '100%', paddingBottom: '20px' }}>
                <View className="w-full flex justify-start items-center h-full p-4">
                    ...
                    {/* cards */}
                    <Animated.View entering={FadeInDown.delay(200).springify()} className='w-full h-1/2'>
                        <Image source={images.cards} resizeMode='contain' className='w-full h-full' />
                    </Animated.View>
                    ...
                    <Animated.View entering={FadeInDown.delay(500).springify()} className='mt-9 w-full'>
                        <CustomButton title="Get Started" handlePress={() => router.push('/home')} containerStyles="w-full" />
                    </Animated.View>
                </View>
            </ScrollView>
