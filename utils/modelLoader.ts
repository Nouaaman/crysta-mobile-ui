...
export const loadModelAssets = (
   modelType: string,
   scaleFactor: string,
): { modelJson: any, modelWeights: any[] } | null => {
   try {
      const modelAssets = {
         "esrgan-slim-x2": {
            modelJson: require("../assets/models/esrgan-slim/x2/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-slim/x2/group1-shard1of1.bin"),]
         },
         "esrgan-slim-x3": {
            modelJson: require("../assets/models/esrgan-slim/x3/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-slim/x3/group1-shard1of1.bin"),]
         },
         "esrgan-slim-x4": {
            modelJson: require("../assets/models/esrgan-slim/x4/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-slim/x4/group1-shard1of1.bin"),]
         },
         "esrgan-slim-x8": {
            modelJson: require("../assets/models/esrgan-slim/x8/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-slim/x8/group1-shard1of1.bin"),]
         },
         //esrgan-medium
         "esrgan-medium-x2": {
            modelJson: require("../assets/models/esrgan-medium/x2/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-medium/x2/group1-shard1of1.bin"),]
         },
         "esrgan-medium-x3": {
         ...
         "esrgan-medium-x4": {
            ...
            modelWeights:
               [require("../assets/models/esrgan-medium/x4/group1-shard1of1.bin"),]
         },
         "esrgan-medium-x8": {
            modelJson: require("../assets/models/esrgan-medium/x8/model.json"),
            modelWeights:
               [require("../assets/models/esrgan-medium/x8/group1-shard1of1.bin"),]
         },
      };
